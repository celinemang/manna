...
// NOTE: The Korean text below is a best-effort transcription and should be
// verified against an authoritative 개역한글 source before public launch.
const KO_TRANSLATION = "개역한글";
const EN_TRANSLATION = "WEB";
...
export const verses: Verse[] = [
  // Anxious
  {
    id: "anxious-001",
    emotion: "anxious",
    reference: { en: "Philippians 4:6–7", ko: "빌립보서 4:6–7" },
    text: {
    ...
    translation: { en: EN_TRANSLATION, ko: KO_TRANSLATION },
    tags: ["anxiety", "peace", "prayer"],
  },
  {
    id: "anxious-002",
    emotion: "anxious",
    reference: { en: "Matthew 6:34", ko: "마태복음 6:34" },
    text: {
  ...
  },
  {
    id: "anxious-003",
    emotion: "anxious",
    reference: { en: "1 Peter 5:7", ko: "베드로전서 5:7" },
    text: {
  ...
  // Lonely
  {
    id: "lonely-001",
    emotion: "lonely",
    reference: { en: "Deuteronomy 31:6", ko: "신명기 31:6" },
    text: {
  ...
  },
  {
    id: "lonely-002",
    emotion: "lonely",
    reference: { en: "Psalm 34:18", ko: "시편 34:18" },
    text: {
  ...
  },
  {
    id: "lonely-003",
    emotion: "lonely",
    reference: { en: "Matthew 28:20", ko: "마태복음 28:20" },
    text: {
  ...
  // Tired
  {
    id: "tired-001",
    emotion: "tired",
    reference: { en: "Matthew 11:28–29", ko: "마태복음 11:28–29" },
    text: {
  ...
  },
  {
    id: "tired-002",
    emotion: "tired",
    reference: { en: "Isaiah 40:31", ko: "이사야 40:31" },
    text: {
  ...
  },
  {
    id: "tired-003",
    emotion: "tired",
    reference: { en: "Psalm 23:1–3", ko: "시편 23:1–3" },
    text: {
  ...
  // Guilty
  {
    id: "guilty-001",
    emotion: "guilty",
    reference: { en: "1 John 1:9", ko: "요한일서 1:9" },
    text: {
  ...
  },
  {
    id: "guilty-002",
    emotion: "guilty",
    reference: { en: "Romans 8:1", ko: "로마서 8:1" },
    text: {
  ...
  },
  {
    id: "guilty-003",
    emotion: "guilty",
    reference: { en: "Psalm 103:12", ko: "시편 103:12" },
    text: {
  ...
  // Grateful
  {
    id: "grateful-001",
    emotion: "grateful",
    reference: { en: "1 Thessalonians 5:16–18", ko: "데살로니가전서 5:16–18" },
    text: {
  ...
  },
  {
    id: "grateful-002",
    emotion: "grateful",
    reference: { en: "Psalm 118:24", ko: "시편 118:24" },
    text: {
  ...
  },
  {
    id: "grateful-003",
    emotion: "grateful",
    reference: { en: "James 1:17", ko: "야고보서 1:17" },
    text: {
  ...
  // Hopeful
  {
    id: "hopeful-001",
    emotion: "hopeful",
    reference: { en: "Jeremiah 29:11", ko: "예레미야 29:11" },
    text: {
  ...
  },
  {
    id: "hopeful-002",
    emotion: "hopeful",
    reference: { en: "Romans 15:13", ko: "로마서 15:13" },
    text: {
  ...
  },
  {
    id: "hopeful-003",
    emotion: "hopeful",
    reference: { en: "Lamentations 3:22–23", ko: "예레미야애가 3:22–23" },
    text: {
...
export function versesByEmotion(emotion: string) {
